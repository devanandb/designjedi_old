	...
	<div class="row">
		<div class="col-lg-6 col-md-6">
			<div class="each-blk">
				...
				<div class="caption">
					Leadership: Tales from the Front
				</div>
				<div class="content">
		...
		<div class="col-lg-12 col-md-12">
			<div class="each-blk">
				<img src="img/life-cover.jpg" alt="">
				<div class="caption">
					It’s Life. Let’s Go Live It!
				</div>
				<div class="content">
					<p>	Go play! Look– work can’t be everything. What do you love? Spend time enjoying it. Granted, last year, I spent more than 200 days traveling for business. But, that didn’t get in the way of swimming, running, riding, hiking, reading, learning, and loving my family. </p>
					<p>Near the end of 2013, after presenting at an event in Barcelona, I even had the fortune to meet up with my daughter in Paris after her studies in Brussels, and travel to Frankfurt, where we flew back to the US together.</p>
				</div>
			</div>
		</div>
	</div>
